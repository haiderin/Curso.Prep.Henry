...
const nuevaString = "Haider Andres Infante Rey";
...
function multiplica(x, y) {
  ...
  // Tu código:
  var multiplicaEjemplo = x * y;
  return multiplicaEjemplo;
}

function divide(x, y) {
  // Divide "x" entre "y" y devuelve el valor
  // Tu código:
  var divideEjemplo = x / y;
  return divideEjemplo;
}
...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var redondiarArriba = Math.ceil(num);
  return redondiarArriba;
}
